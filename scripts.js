...
var deltaLat;
var deltaLng;
var position = [25.84971235, -97.50386492]; //lat lon CEID
...
function initMap() { // Google Map Initialization... 
    map = new google.maps.Map(document.getElementById('map'), {
        zoom: 16,
        center: new google.maps.LatLng(25.84971235, -97.50386492),
...
var cars_Ref = firebase.database().ref('/LAMPARAS_E3_MAT');


var dataConductores = firebase.database().ref('/LAMPARAS_E3_MAT');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E3_MAT');
